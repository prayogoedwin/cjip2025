...
<body class="antialiased">
    ...
    @isset($locations)
        <script>
            ...
            var redirect =
                '<a href="https://bursakerja.jatengprov.go.id/home/register_penyedia_kerja_sidikaryo/99" target="blank" class="btn btn-primary rounded py-1 text-sm flex justify-center mt-2 px-1 font-semibold">Buat Lowongan di Emakaryo</a>';
