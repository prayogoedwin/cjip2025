<div class="book">
    <div class="page" id="result">
        <center>
            ...
            <p style="font-size:20px">SEKRETARIS DAERAH <br>KEPUTUSAN SEKRETARIS DAERAH <br>PROVINSI JAWA TENGAH</p>
            <p>NOMOR …/… TAHUN 2024</p>
            <p>TENTANG</p>
            <p>PEMBERIAN INSENTIF DAN KEMUDAHAN PENANAMAN MODAL <br>
                SEKRETARIS DAERAH <br>PROVINSI JAWA TENGAH,
            </p>
        </center>
        <table>
            <tr>
        ...
        <div style="float:right">
            <div style="width: 250px;text-align: left;">
                ...
                <center>
                    <p>SEKRETARIS DAERAH <br>PROVINSI JAWA TENGAH,</p>
