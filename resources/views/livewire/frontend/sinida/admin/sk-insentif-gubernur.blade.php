<div class="book">
    <div class="page" id="result">
        <center>
            <img src="{{ asset('images/garuda.jpg') }}" alt="" width="120px">
            <h3>GUBERNUR JAWA TENGAH</h3>
            <p style="font-size:20px">KEPUTUSAN GUBERNUR JAWA TENGAH</p>
        ...
        <div style="float:right">
            <div style="width: 250px;text-align: left;">
                <p>Ditetapkan di Semarang</p>
                <p>Pada Tanggal.........................<?= date('Y') ?></p>
