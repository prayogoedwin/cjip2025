        ...
        <div class="justify-center flex">
            <div
                ...
                <a class="justify-center flex" href="{{ route('beranda') }}">
                    <img src="{{ asset('assets/images/logo.png') }}" class="l-dark" style="width: 70px" alt="">
                </a>
                ...
                <form class="text-start" wire:submit.prevent="loginAction">
                    <div class="grid grid-cols-1">
                        ...
                        <div class="mb-4">
                            <button type="submit" class="btn btn-primary rounded-md shadow-md my-2 w-full"
                        ...
                        <div class="text-center">
                            <span class="text-slate-400 me-2">Don't have an account ?</span> <a
                                href="#"
                                class="text-black dark:text-white font-bold inline-block hover:text-primary-500">Register</a>
                        </div>
                    </div>
                </form>
            </div>
