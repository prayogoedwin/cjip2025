            ...
            <div class="bg-white dark:bg-slate-900 p-6 rounded-lg flex flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-1/2 lg:ml-6">
                    ...
                    <button onclick="window.history.back()"
                        class="items-center px-6 py-3 text-sm mb-2 font-medium text-center mt-2 text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 transition duration-300 w-full">
                        Kembali
                    </button>
