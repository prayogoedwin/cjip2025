<div>
    <div
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-5">
            <!-- Announcement Banner -->
            ...
            <div class="mt-10 max-w-2xl text-center mx-auto">
                <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
                    {{ __('proyek.title_sector', [], $locale) }}</h3>
                </h1>
            </div>
            <!-- End Title -->

            <div class="mt-2 max-w-3xl text-center mx-auto">
                <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('proyek.sub_title', [], $locale) }}</p>
            </div>
        </div>
    </div>

    @livewire('proyek.sektor-content')
</div>
