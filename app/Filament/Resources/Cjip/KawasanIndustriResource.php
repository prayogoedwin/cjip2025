...
class KawasanIndustriResource extends Resource
{
    ...
    protected static ?string $pluralLabel = 'Data Kawasan Industri';
            ...
            ->columns([
                Split::make([
                    ...
                    Stack::make([
                        ...
                        TextColumn::make('updated_at')->date('d F Y')->wrap()->label('Jenis Kawasan Industri')->sortable()
